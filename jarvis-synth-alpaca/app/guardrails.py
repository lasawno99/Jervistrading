...
def check_order(
    ...
    *,
    ...
    # 2 — broker-specific environment check (OANDA practice or Alpaca paper-api).
    # The executor itself enforces its broker check; the guardrail only requires
    # *some* paper venue is selected via TRADING_MODE above.
