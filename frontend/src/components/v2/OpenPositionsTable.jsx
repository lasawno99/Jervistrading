  ...
  return (
    ...
    >
      ...
      {rows.length === 0 ? (
        ...
        <div className="overflow-x-auto -mx-1 scroll-y">
          <div className="min-w-[420px] px-1">
            <div className="grid grid-cols-12 gap-2 text-[10px] tracking-[0.06em] uppercase text-white/35 pb-2 border-b border-white/5">
